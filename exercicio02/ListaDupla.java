...
public class ListaDupla {
    ...
    public String buscaAlunoNome(String nome) {
        AlunoNoDuplo temp_no = primeiro;
        String retorno = "O Aluno não foi encontrado na lista de ADS!";

        while(temp_no != null) {
            if(temp_no.aluno.getNome().equals(nome)) {
                retorno = "RA do aluno: " + temp_no.aluno.getRa();
            }
